...
// var i = 0;
var questions_arr = ["Hvor var du kl.15:30, da Ann Helen ble drept?", "Hvorfor har du lånt de bøkene som står på lånelisten?", "What was your reason for coming here tonight?", "What do you do for a living?", "When did you last see the deceased?", "Where were you at the time of the murder?", "Can you expand on a piece of evidence?", "Do you know anyone who wanted to kill the deceased?"];


var ans_arr1 = ["Jeg skulle vel egentlig til Latinskolen, og møte Kai Åge. Han og noen elever skal lage en musikkvideo med drone-flygning – og da må Kai passes litt ekstra på slik at ikke tusener av kroner deiser i bakken. Ja, hvor var jeg ja … Jeg ventet på en pakke som skulle komme på fredagen, også endte jeg opp med å bli sittende alene på kontoret og arbeide. Setter en på noe god musikk så flyr tiden helt fra en."];
var ans_arr2 = ["Jeg stakk opp i 6.etg kl.15 for å møte Vidar."];
var ans_arr3 = ["Er det bare ett mord? - Jeg ville nå tatt flere i slengen om jeg først skulle drepe noen. Vet ikke helt hvor jeg var. Jeg pleier nå å tusle rundt i gangene. Husker ikke alltid hva jeg gjør. Bare så det er sagt, jeg er uskyldig altså. Jeg er bare en vanlig mann som spiser sin pølse i vaffel og lar andre gjøre sitt.", "Trengte eksempel til oppgave om bokomslag i MK."];
var ans_arr4 = ["Satt og arbeidet på kontoret i 5.etg."];
var ans_arr5 = ["Ja, det var Ann Helen som ble drept ja. Det ble et kortlevd forfatter-eventyr. Jeg møtte på Ann Helen like før det, kanskje kl.15.. Vi pratet bare litt om bøker, også boken hennes da. Ikke så mye spennende. Etterpå gikk jeg bort I kantinen med Iwona for å hente fredags-rundstykkene."];
